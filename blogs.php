        ...
        <div class="app-container">
            ...
            <div class="grid-2">
                ...
                <?php foreach ($blogs as $blog) { ?>
                    <div class="content">
                        <div class="title-text"><?php echo htmlspecialchars($blog["title"]) ?></div>
                        <div class="body"><?php echo nl2br(htmlspecialchars($blog["body"])) ?></div>
                        <a href="./blog_details.php?blog_id=<?php echo $blog["id"] ?>">READ MORE</a>
                        <div class="text-sm"><i class="fa fa-user"></i> Ambassador: <?php echo htmlspecialchars($blog["author"]) ?></div>
                    </div>
                <?php } ?>
                <!--  -->
            </div>
