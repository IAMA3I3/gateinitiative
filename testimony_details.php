...
try {
    ...
    $query = "SELECT * FROM testimonies WHERE id = :id;";
...
<body>
    ...
    <!-- showcase -->
    <div class="showcase">
        <img src="./assets/img/testimony.jpg" alt="">
        <div class="overlay">
            <div class="text-xl">What Would You Like To Tell GATE INITIATIVE?</div>
        </div>
    ...
    <div class="py">
        <div class="app-container">
            <div class="text-sm mb"><i class="fa fa-user"></i> <?php echo htmlspecialchars($testimony["author"]) ?></div>
            <div class="twocolumns"><?php echo nl2br(htmlspecialchars($testimony["testimony"])) ?></div>
        </div>
    </div>
    <!--  -->
    ...
    <section class="mb py donate min">
        <div class="">
            <div class="text-lg text-center mb-lg">More Testimonies</div>
            <div class="image-slider">
                <div class="slider-wrapper">
                    ...
                    <div class="image-list">
                        <!--  -->
                        <!--  -->
                        <?php foreach ($testimonies as $each_testimony) { ?>
                            <div class="content">
                                <div class="title-text">What Would You Like To Tell GATE INITIATIVE?</div>
                                <div class="body"><?php echo nl2br(htmlspecialchars($each_testimony["testimony"])) ?></div>
                                <a href="./testimony_details.php?testimony_id=<?php echo $each_testimony["id"] ?>">READ MORE</a>
                                <div class="text-sm"><i class="fa fa-user"></i> <?php echo htmlspecialchars($each_testimony["author"]) ?></div>
                            </div>
                        <?php } ?>
                        <!--  -->
                        <!--  -->
